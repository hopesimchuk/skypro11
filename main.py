...
from utils import load_candidates_from_json, get_candidate, get_candidates_by_name, get_candidate_by_skill
...
def search_candidates_by_name_page(candidate_name):
    candidate: dict = get_candidates_by_name(candidate_name)
...
def search_candidates_by_skill_page(skill_name):
    candidates: dict = get_candidate_by_skill(skill_name)
